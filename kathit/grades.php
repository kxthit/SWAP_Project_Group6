...
<head>
    ...
    <style>
        ...
        .student-card:hover {
            ...
            box-shadow: 0px 7px 29px 0px rgba(100, 149, 237, 0.7);
            /* Subtle glow effect */
        ...
        .filters input[type="text"] {
            width: 300px;
            /* Adjust the width to make the search bar longer */
            padding: 5px;
            border-radius: 5px;
        ...
        .filters select {
            padding: 5px;
            /* Increases the space inside the dropdown, making it thicker */
            font-size: 13px;
            ...
            /* Border styling */
            height: 30px;
            /* Increases the height of the dropdown */
        }

        /* Optional: Add styling for the dropdown options */
        .filters select option {
            padding: 10px;
            /* Add padding to the options if needed */
        }
