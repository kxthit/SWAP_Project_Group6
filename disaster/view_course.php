...
<body>
    ...
    <div class="main-container">
        <div class="course-details">
            ...
            <!-- Edit Course button: Use course_id from session -->
            <button onclick="location.href='course_updateform.php?course_id=<?php echo htmlspecialchars($_SESSION['session_courseid']); ?>'">Edit Course</button>
            <button onclick="location.href='courses.php'">Back to Course List</button>

            <!-- Delete Course Form: Use course_id from session -->
