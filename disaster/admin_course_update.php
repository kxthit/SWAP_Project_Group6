...
$query= $con->prepare("UPDATE course SET course_name=?,course_code=?,`start_date`=?,`end_date`=?,`status_id`=?,`department_id`=? WHERE `course_id`=?");
...
$upd_courseid = htmlspecialchars($_GET["gcourse_id"]);
