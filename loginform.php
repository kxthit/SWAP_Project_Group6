...
.welcome-img {
    max-width: 50%;  /* Ensure the image does not overflow */
...
.error-message {
    ...
    top: 120px; /* Adjust based on where you want it to appear */
    left: 50%;
    transform: translateX(-50%); /* Center horizontally */
    text-align: center;
    z-index: 1; /* Ensure it appears above other elements */
    width: 60%; /* Optional: Limit width for long messages */
    background-color: #f8d7da; /* Light red background for better visibility */
    padding: 10px; /* Padding inside the error box */
    border: 1px solid #f5c6cb; /* Border for better distinction */
    border-radius: 5px; /* Rounded corners */
    box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); /* Subtle shadow for styling */
}
    </style>
</head>
<body>
