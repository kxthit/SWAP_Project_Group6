    ...
    <div class="form-container">
        ...
        <label for="course_name">Course Name:</label>
            <input type="text" id="course_name" name="course_name" class="form-input"
                   value="<?php echo isset($form_data['course_name']) ? htmlspecialchars($form_data['course_name'], ENT_QUOTES, 'UTF-8') : ''; ?>" >

            <label for="course_code">Course Code:</label>
            <input type="text" id="course_code" name="course_code" class="form-input"
                   value="<?php echo isset($form_data['course_code']) ? htmlspecialchars($form_data['course_code'], ENT_QUOTES, 'UTF-8') : ''; ?>" >

            <label for="start_date">Start Date:</label>
            <input type="date" id="start_date" name="start_date" class="form-input"
                   value="<?php echo isset($form_data['start_date']) ? $form_data['start_date'] : ''; ?>" >

            <label for="end_date">End Date:</label>
            <input type="date" id="end_date" name="end_date" class="form-input"
                   value="<?php echo isset($form_data['end_date']) ? $form_data['end_date'] : ''; ?>" >

            <label for="status_id">Status:</label>
            <select id="status_id" name="status_id" class="form-select">
                <option value="" disabled>--- Select Status ---</option>
                <?php while ($status = $statusResult->fetch_assoc()): ?>
                    <?php $selected = (isset($form_data['status_id']) && $form_data['status_id'] == $status['status_id']) ? 'selected' : ''; ?>
