...
if ($_SESSION['session_roleid'] == 1) {
    echo "<h2> Please use the Admin Insert Form. </h2>";
    header('Refresh: 3; course_admin_insert_form.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (strlen($course_name) >= 200) {
        $_SESSION['error_message'] = "Course name must be between 1 and 200 characters.";
